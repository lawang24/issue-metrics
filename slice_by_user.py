...
def slice_pr_by_user(issues_with_metrics):
    ...
    for issue in issues_with_metrics:
        ...
        if author in author_stats:
            ...
            author_stats[author]["total_time_to_first_response"] += issue.time_to_first_response
            author_stats[author]["total_time_to_close"] += issue.time_to_close
            author_stats[author]["total_time_to_answer"] += issue.time_to_answer
            author_stats[author]["count"] += 1
        else:
            # Initialize this author's stats with all necessary metrics
            author_stats[author] = {
                "total_time_to_first_response": issue.time_to_first_response,
                "total_time_to_close": issue.time_to_close,
                "total_time_to_answer": issue.time_to_answer,
                "count": 1
            }
